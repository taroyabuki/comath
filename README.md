...
Wolfram言語|Mathematica|[mathematica.nb](code/mathematica/mathematica.nb) あるいは `Import["https://wolfr.am/1gw1HOigM", "NB"]`
...
- [すべてのRaspberry PiでWolfram言語とMathematicaが無料で使えます！](https://www.wolfram.com/raspberry-pi/)
### そのほかの環境
